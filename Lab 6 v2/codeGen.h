enum code_ops {START,HALT, LD_INT_VALUE, STORE, WRITE_INT, LD_VAR, ADD, LD_INT, LTN, JMP_FALSE, GOTO, LABEL};

char *op_name[] = {"start", "halt", "ld_int_value", "store", "write_int", "ld_var", "add", "ld_int", "lt", "jmp_false", "goto", "label"};
